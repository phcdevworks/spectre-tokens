...
| Path | Status |
|---|---|
| `tokens/*.json` | May edit — source of truth |
| `contract.manifest.json` | May edit — contract authority |
| `src/index.ts` · `src/types.ts` · `src/css.ts` | May edit — contract-authority files, require changelog classification |
| `scripts/` | May edit |
| `README.md` · docs | May edit — keep aligned with manifest |
| `src/generated/tokens.ts` | **Never edit** — regenerated by `npm run build` |
| `dist/` | **Never edit** — regenerated by `npm run build` |
| Protected color families | **Require Bradley Potts approval** — `success`, `warning`, `danger`, CTA / brand-action |
